...
function underscores_scripts() {
    wp_enqueue_style( 'underscores-style', get_stylesheet_uri() . '/../dist/assets/css/main.min.css' ,false,'1.0','all' );
    ...
    wp_enqueue_script( 'underscores-main', get_template_directory_uri() . '/dist/assets/js/main.min.js', false, '1.0', 'all' );
